class WeatherRequest < ApplicationRecord
  ...
  def weather_info
    ...
    OpenStruct.new(weather_time: condition['date'],
                   temperature:  Formulas.fahrenheit_to_celsius(condition['temp'].to_f),
                   feels_like:   Formulas.fahrenheit_to_celsius(wind['chill'].to_f),
  ...
  def weather_forecasts
    ...
    forecasts.each do |forecast|
      forecast_array << OpenStruct.new(date:        forecast['date'],
                                       ...
                                       temp_high:   Formulas.fahrenheit_to_celsius(forecast['high'].to_f),
                                       temp_low:    Formulas.fahrenheit_to_celsius(forecast['low'].to_f),
